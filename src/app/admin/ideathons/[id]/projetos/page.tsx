...
export default function ProjectsPage() {
  ...
  return (
    <AppShell navigation="management" activeSection="ideathons" darkHeader headerAction={<button type="button" onClick={openProjectModal} className="inline-flex min-h-9 items-center gap-2 rounded-full bg-lime px-4 text-xs font-bold text-lime-foreground transition-colors hover:bg-lime/85"><Plus className="size-3.5" />Add Project</button>}>
      <div className="mx-auto w-full max-w-container space-y-6 px-4 py-7 sm:px-6 lg:px-8 lg:py-9">
        <section className="flex flex-col justify-between gap-5 xl:flex-row xl:items-end"><div><h1 className="text-3xl font-bold tracking-[-0.055em] text-ink sm:text-4xl">Gestão de Projetos</h1><p className="mt-2 text-base text-ink-muted">FinTech Innovate 2024</p></div><Button type="button" onClick={openProjectModal}><Plus className="size-4" />Cadastrar Novo Projeto</Button></section>
