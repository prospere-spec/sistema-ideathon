...
import { ArrowRight, Eye, EyeOff, LockKeyhole, Mail, Rocket } from "lucide-react";
  ...
  return (
    <main className="grid min-h-screen bg-white lg:grid-cols-[minmax(480px,1fr)_minmax(520px,1fr)]">
      <section className="relative flex min-h-screen flex-col px-6 py-8 sm:px-10 lg:px-16 xl:px-[8.5vw]" aria-labelledby="login-title">
        <Link href="/login" className="relative h-10 w-40 overflow-hidden" aria-label="Revvolução, página inicial"><img src="/brand/logo-revvolucao.png" alt="Revvolução" className="absolute left-0 top-1/2 h-[90px] max-w-none -translate-y-1/2" /></Link>
